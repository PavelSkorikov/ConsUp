...
with open('info.txt', 'w') as f:
    f.write(r"""Программа ConsUp предназначена для синхронизации файлов баз данных 
...
на последние загруженные в базу Консультант+. 
    Запуск программы ConsUp.exe настроить на удобное время в системном планировщике задач.
...
updproc = Popen(['../cons.exe', '/adm', '/receive', '/base*', '/sendstt', '/yes'], stdout=PIPE)
updproc.wait()
if updproc.returncode != 0:
